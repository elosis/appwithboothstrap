    ...
    <div>
      ...
      <div className="mx-auto" style={{ maxWidth: "1436px" }}>
        ...
        <div className="container border mt-5">
          <p>
            Welcome to the NOOK® bookstore, where you'll find a vast selection
            of eBooks to satisfy your love of reading.
          </p>
          <h5>Benefits of eBooks</h5>
          <p>
            There are many benefits to owning and reading an eBook compared to a
            print book. Some of the main benefits are accessibility,
            portability, convenience, personalization, and privacy.
          </p>
          <ul>
            <li>
            ...
            <li>
              Portability – eBooks can go wherever you go, since they can be
              read on your phone or tablet.
            </li>
            <li>
              Convenience – you can add notes, highlights, bookmarks, and look
              up words directly on your eBook, which is especially great when
              you’re reading a guide, textbook, or workbook.
            </li>
            <li>
              Personalization – You can adjust the brightness of your screen,
              font size, and more.
            </li>
            <li>
              Privacy – You can read without others seeing what book you've
              chosen while commuting or while in public.
            </li>
          </ul>
          <h5>Find Free eBooks</h5>
          <p>
            Another exciting benefit of eBooks is that you can find many free
            books to read! From a great collection of free fiction and
            non-fiction eBooks to free eBooks for toddlers and kids, we have a
            wide array of free books to download. For literary buffs, we have a
            great collection of classic literature from critically acclaimed
            authors, completely free to read. You can find great literary works
            by writers like George Orwell, Oscar Wilde, Charlotte Brontë, Mark
            Twain, Jane Austen, Charles Dickens, and Alexandre Dumas at no cost.
            There’s also a tantalizing selection of series that you can start
            for free! If you're in the mood for light reading, be sure to
            explore a great collection of free magazines. Plus, all of our
            digital magazines come with a free 14-day trial!
          </p>
          <h5>eBooks for Kids</h5>
          <p>
            Growing kids can go through more books than parents can keep up
            with. You may want to switch over to eBooks for a convenient and
            fast experience. You won’t have to worry about packing the rights
            books or forgetting the books when going on a trip. eBooks are also
            great because they don’t weigh down your bag. There’s a wide variety
            of children's eBooks to choose from. Browse kid’s fiction eBooks,
